...
//----------------------------------------------------------------
	...
	// This overloads the "<" operator which lets
   // us  compare one value to another and tell if it is less
	...
	// This overloads the ">" operator which lets
	// us compare one value to another and tell if it is greater
	bool operator>(const Node& obj) {
	...
	// This overloads the Equivalent (==) operator allowing
